...
.const [1] = Utf8 net/mcreator/createstuffadditions/item/SlimeItem$Boots
.const [2] = Class [1]
...
.const [35] = Utf8 this
.const [36] = Utf8 Lnet/mcreator/createstuffadditions/item/SlimeItem$Boots;
...
.const [60] = Utf8 " "
.const [61] = String [60]
.const [62] = Utf8 "\u00A75这双充满弹性的靴子可以让你"
.const [63] = String [62]
.const [64] = Utf8 "\u00A7d跑得更快\u00A75以及让你从大部分致死"
.const [65] = String [64]
.const [66] = Utf8 "\u00A7d的摔落中存活下来！"
.const [67] = String [66]
...
.const [93] = Utf8 net/mcreator/createstuffadditions/procedures/SlimeBootsTickEventProcedure
.const [94] = Class [93]
